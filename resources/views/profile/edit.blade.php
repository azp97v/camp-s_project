...
@section('title', 'الملف الشخصي - Step by Step')
    ...
    <section class="profile-section" dir="rtl" lang="ar">
        <div class="container">
                        ...
                        <div class="form-group">
                            ...
                            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                                <div class="verification-notice mt-3">
                                    ...
                                    <form id="send-verification" method="post" action="{{ route('verification.send') }}" class="inline mt-2">
                                        @csrf
            ...
            <div class="profile-card glass">
                ...
                <div class="profile-card-content">
                    <form id="password-form" method="post" action="{{ route('user.password.update') }}" class="space-y-6">
                        @csrf
                        @method('put')
