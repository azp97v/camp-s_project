...
@section('title', 'الإعدادات - Step by Step')
        ...
        <div class="container">
            ...
            <div class="settings-card glass">
                ...
                <div class="settings-card-content">
                    ...
                    <a href="{{ route('profile.edit') }}" class="btn btn-primary">✏️ تعديل البيانات</a>
                </div>
            </div>
            ...
            <div class="settings-card glass">
                ...
                <div class="settings-card-content">
                    ...
                    <a href="{{ route('profile.update') }}" class="btn btn-primary">🔑 تغيير كلمة المرور</a>
                </div>
            </div>
            ...
            <div class="settings-card glass danger-zone">
                ...
                <div class="settings-card-content">
                    ...
                    <div class="danger-action">
                        ...
                        <form action="{{ route('profile.destroy') }}" method="POST" class="inline" onsubmit="return confirm('هل تريد فعلاً حذف حسابك؟ لا يمكن التراجع عن هذا الإجراء.');">
                            @csrf
                            @method('DELETE')
            ...
            <div class="text-center mt-8">
                <a href="{{ route('dashboard') }}" class="btn btn-ghost">← العودة إلى اللوحة</a>
            </div>
        </div>
    </section>
@endsection
