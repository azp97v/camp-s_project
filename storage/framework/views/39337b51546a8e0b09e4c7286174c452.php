...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-full">إنشاء حساب</button>
                ...
                <div class="register-footer">
                    <p>لديك حساب بالفعل؟ <a href="<?php echo e(route('login')); ?>" class="login-link">تسجيل الدخول</a></p>
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\camp's_project\resources\views/register.blade.php ENDPATH**/ ?>