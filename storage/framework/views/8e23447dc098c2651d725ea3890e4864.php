            ...
            <div class="flex items-center">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-2">
                        ...
                        <span class="hidden sm:inline font-bold text-lg text-slate-800"><?php echo e(config('app.name')); ?></span>
                    </a>
                </div>
...
<?php endif; ?>
        ...
        <div class="pt-4 pb-1 border-t border-slate-200/30">
            <div class="px-4">
                <div class="font-semibold text-base text-slate-800"><?php echo e(Auth::user()->name); ?></div>
                <div class="font-medium text-sm text-slate-600"><?php echo e(Auth::user()->email); ?></div>
            </div>
...
<?php /**PATH C:\xampp\camp's_project\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>