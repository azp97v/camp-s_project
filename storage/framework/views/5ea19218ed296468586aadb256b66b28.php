...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" dir="rtl">
    <head>
        ...
        <title><?php echo e(config('app.name', 'Laravel')); ?> - إدارة أهدافك ومهامك</title>
    ...
    <body class="antialiased">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center">
                        ...
                        <span class="hidden sm:inline ms-3 font-bold text-lg text-slate-800"><?php echo e(config('app.name')); ?></span>
                    </div>

                    <div class="flex items-center gap-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('dashboard')); ?>" class="btn-primary">الذهاب للداشبورد</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="btn-ghost">تسجيل الدخول</a>
                            <a href="<?php echo e(route('register')); ?>" class="btn-primary">إنشاء حساب</a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center animate-on-load">
                    ...
                    <div>
                        ...
                        <div class="flex gap-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(route('dashboard')); ?>" class="btn-primary text-lg px-8 py-3">
                                    ابدأ الآن ➜
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('register')); ?>" class="btn-primary text-lg px-8 py-3">
                                    إنشاء حساب مجاني
                                </a>
                                <a href="<?php echo e(route('login')); ?>" class="btn-ghost text-lg px-8 py-3">
                                    هل لديك حساب؟
                                </a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
        ...
        <section class="py-24 bg-gradient-to-r from-sky-400/10 to-purple-600/10">
            <div class="max-w-4xl mx-auto px-4 text-center animate-on-load">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn-primary text-lg px-10 py-4">
                        اذهب للداشبورد الآن ➜
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>" class="btn-primary text-lg px-10 py-4">
                        إنشاء حساب مجاني ➜
                    </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        ...
        <footer class="py-12 text-center text-slate-600 border-t border-slate-200/30 glass">
            <div class="max-w-7xl mx-auto px-4">
                <p class="mb-2">© <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?> • جميع الحقوق محفوظة</p>
...
<?php /**PATH C:\xampp\camp's_project\resources\views/welcome.blade.php ENDPATH**/ ?>